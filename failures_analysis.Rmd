...
For this project the performance will be measure by: Produced Lenght Between Failures.<br />
...
**Even it's shown that the products have incresead the lenght by unit, 62 meters aren't enough to affirm that the lenght has impact to the number of failures.**<br />
...
Since the product can be measured by lenght, by analysing the number of failures per secction can bring up some insights that could help to understand if the failures occur more at the begin of the proccess, at the middle of the proccess or at the end of the proccess.
